              ...
              <div className=" flex ">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 px-4">
                  {workoutPlans.map((workoutplan, i) => (
                    <div
                      className="flex flex-col border p-1 border-accent rounded-lg md overflow-hidden shadow-lg transform transition duration-500 hover:scale-105 cursor-pointer"
                      key={i}
                    >
                      <img
