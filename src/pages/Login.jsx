  ...
  const [password, setPassword] = useState('');
    ...
    return(
      <main style={{display:"flex"}}>
            <div className='bg-gray-700 flex flex-col justify-center' style={{width:"100vw",height:'100vh'}}>
        ...
        <p className='text-blue-900' style={{ alignSelf: 'flex-end' }}>Forgot password?</p>
      </div>
            <div>
              <button disabled={email.includes('@') && password ? false:true} className='bg-green-600 text-gray-300 text-xl rounded-l mt-5 w-full h-8' onClick={handleLoginSubmit}>Login</button>
            </div>
          </div>
